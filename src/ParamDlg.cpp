...
: m_color_cbs()
{
    ...
    m_Function.append(Glib::ustring::sprintf("%c", static_cast<gchar>(Function::Mandelbrot)), TEXT_MANDELBROT);
    m_Function.append(Glib::ustring::sprintf("%c", static_cast<gchar>(Function::Juliaset)), TEXT_JULIASET);
    m_Function.append(Glib::ustring::sprintf("%c", static_cast<gchar>(Function::Newton)), TEXT_NEWTON);
    ...
    m_Function.set_active_id(Glib::ustring::sprintf("%c", static_cast<gchar>(param->getFunction())));
...
ParamDlg::refresh(std::shared_ptr<Param> param)
{
    ...
    param->setFunction(Param::char2Function(m_Function.get_active_id().at(0)));
